...
*Check the [full announcement and guide here](https://blog.awardfares.com/price-alerts/).*
...
The timeline just got even more helpful! We've added a handy **alert indicator** to the mix. Now, when you search for a route, you'll see a little bell icon next to any dates that have an existing alert set up for them. This way, you can easily see which travel dates you've already configured to receive notifications about potential award availability.
