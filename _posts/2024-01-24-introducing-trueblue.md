...
<img src="../assets/img/introducing-trueblue/route.webp" alt="Select a route when searching a TrueBlue award in AwardFares." class="noborder"/>

### 4. Choose or explore dates

If you have a particular date in mind, add it by tapping on the **Calendar** field.

<img src="../assets/img/introducing-trueblue/calendar.webp" alt="Select a date when searching a TrueBlue award in AwardFares." class="noborder"/>
...
Once you have identified the flight(s) you want, tap on the **Book** button, and AwardFares will redirect you to JetBlue's website, setting your query directly, so you don't have to redo the search. Finish the booking process right there! <sup>1</sup>.

<img src="../assets/img/introducing-trueblue/book.webp" alt="Book JetBlue TrueBlue award flights from AwardFares." class="noborder"/>

*Remember that AwardFares will never ask for the login credentials of any of your frequent flyer programs to work.*

<img src="../assets/img/introducing-trueblue/booking-jetblue-site.webp" alt="Find the cheapest JetBlue TrueBlue awards with AwardFares." class="noborder"/>
...
<figure>
<img src="../assets/img/introducing-trueblue/mint-1.webp" />
<img src="../assets/img/introducing-trueblue/mint-2.webp" />
</figure>
