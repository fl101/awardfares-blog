...
<img src="../assets/img/introducing-aeromexico-rewards/timeline-view.gif" alt="Explore Virgin Atlantic Flying Club awards for different dates in AwardFares." class="noborder"/>

You'll see the result list right below:

<img src="../assets/img/introducing-aeromexico-rewards/results.webp" alt="Explore Flying Club awards for different dates in AwardFares." class="noborder"/>
...
<img src="../assets/img/introducing-aeromexico-rewards/details.webp" alt="Expand details for a given flights when searching a Flying Club award in AwardFares." class="noborder"/>
...
<img src="../assets/img/introducing-aeromexico-rewards/sort-by-price.gif" alt="Find the cheapest Virgin Atlantic Flying Club awards with AwardFares." class="noborder"/>
...
<img src="../assets/img/introducing-aeromexico/aeromexico-website.webp" alt="Virgin Atlantic 787 Dreamliner." class="noborder"/>
